...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: A person with zero turns was not added back into the queue, even though zero represents infinite turns.
    ...
    // Defect(s) Found: A person with negative turns was not added back into the queue, even though negative values represent infinite turns.
